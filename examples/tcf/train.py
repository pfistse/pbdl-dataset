...
train_data = PBDLDataset(
    "transonic-cylinder-flow-tiny", time_steps=TIME_STEPS, normalize=True
)

train_dataloader = PBDLDataLoader(train_data, batch_size=BATCH_SIZE, shuffle=True)
